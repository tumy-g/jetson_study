...
while cap.isOpened():
    ...
    if detector.detect(image):
        ...
        draws.draw_finger_angle(white_image, "Index", 0, 290, int(index_angle*10), 340)
        draws.draw_finger_angle(white_image, "Middle", 0, 350, int(middle_angle*10), 400)
        draws.draw_finger_angle(white_image, "Pinky", 0, 410, int(pinky_angle*10), 460)
